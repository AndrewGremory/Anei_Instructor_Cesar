...
<div class="container text-center">
       ...
       <div class="col"><input type="button" class="btn btn-primary" data-toggle="modal" data-target="#digiturno" value="Nuevo Secado"  onclick="con_secadora();"></div>                    
                        ...
                        <div class="form-group row ">
                         ...
                         <div class="form-group row">
                          <div class="offset-lg-1 col-lg-8">
                            ...
                            <button  onclick="digiturno();">Guardar</button>
